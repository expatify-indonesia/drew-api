...
class Drew {
  ...
  public function orderFulfilled($post){
    ...
    // Define the order ID variable
    $order_id = $post['admin_graphql_api_id'];
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, "https://binsar-playground.myshopify.com/admin/api/2024-01/graphql.json");
    curl_setopt($ch, CURLOPT_POST, 1);
    curl_setopt($ch, CURLOPT_POSTFIELDS, '{"query":"query{\\n  order(id: \\"'.$order_id.'\\"){\\n    customer {\\n      id\\n    }\\n    email\\n    lineItems(first: 250) {\\n      nodes{\\n      \\tquantity\\n        product {\\n          id\\n          title\\n          metafield(namespace: \\"custom\\" key: \\"guaranteed_product\\") {\\n            value\\n          }\\n        }\\n      }\\n    }\\n    billingAddress {\\n      country\\n      city\\n      province\\n    }\\n  }\\n}","variables":{}}');
    ...
    // CREATE PEOPLE IN CUSTOMER.IO IF NOT EXISTS
...
$merged_data = array_merge($data, $_FILES);
call_user_func_array(array($action, $method), array($merged_data));
