...
{
  public $data;
  public $campaign_webhook = 'https://api.customer.io/v1/webhook/09a5b8dc5829535b';
  ...
  public function partReplaced($post)
  {
    ...
    $product_details = array(
      ...
      "date_reminder" => $reminder_period,
      "date_reminder_formated" => date('d F Y', strtotime($reminder_period)),
      "date_reminder_timestamp" => strtotime($reminder_period),
